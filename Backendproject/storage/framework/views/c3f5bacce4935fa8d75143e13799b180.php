  ...
  <nav class="bg-gray-800" x-data="{ isOpen: false }">
    ...
    <header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Contact Person</h1>
      </div>
    </header>
    <main>
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
...
</html><?php /**PATH C:\laragon\www\example-app\resources\views/contact.blade.php ENDPATH**/ ?>