        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <a href="/" class="<?php echo e(request() -> is('/') ? 'bg-gray-900 text-white' :  'text-gray-300 hover:bg-gray-700 hover:text-white'); ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Content</a>
        ...
        <div class="container">
          ...
          <ul class="task-list">
              <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li class="task-item <?php echo e($task->completed ? 'completed' : ''); ?>">
                      <span class="title"><?php echo e($task->title); ?></span>
                      <div class="task-actions">
                          <form action="/tasks/<?php echo e($task->id); ?>" method="POST" style="display: inline;">
                              <?php echo csrf_field(); ?>
                              <?php echo method_field('PATCH'); ?>
                              <input type="image" src="images/Ceklist.png" alt="submit" width="30" height="25" <?php echo e($task->completed ? 'Undo' : ''); ?>>
                          </form>
                          <form action="/tasks/<?php echo e($task->id); ?>" method="POST" style="display: inline;">
                              <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\example-app\resources\views/tasks/index.blade.php ENDPATH**/ ?>